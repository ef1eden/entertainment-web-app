<template>
  <swiper
    ...
    :freeMode="true"
  >
    <swiper-slide v-for="video in trendingVideos" :key="video.id" :video="video">
        <div class="trending-item">
            ...
            <img class="item-photo" :src="require(`../assets/images/thumbnails/${video.thumbnail.trending.large}`)" alt="">
